...
public class StringUtil extends org.apache.commons.lang.StringUtils {
    ...
    public static boolean isNotBlank(String str) {
        return org.apache.commons.lang.StringUtils.isNotBlank(str) && !str.equals("null");
    }
     ...
     * @return
     */
    public static int countExist(String content,String key){
        int beforeLength = content.length();
        String replace = content.replace(key, "");
        int afterLength = replace.length();
