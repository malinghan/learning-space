...
import com.mlh.learning.download.ServerHolder;
...
public class HttpUtil {
    ...
    public static String getPramFromQueryStr(String queryStr, String paramName) {
    ...
    public static String sendPost(String url, List<BasicNameValuePair> paramList) throws IOException {
        HttpClient httpClient = ServerHolder.getInstance().createClientWithPool();
