...
public class MethodHandleTest {
    ...
    /**
     * 如何定义一个MethodType: MethodType.methodType
     *     第一个参数:方法的返回值
     *     第二个参数:方法的参数
     *
     * 如何利用MethodType定义一个动态方法
     *   1. 绑定接收者
     *   2. 指定方法的MethodType、接收者的实际类型、接收者实际的方法名
     *   3. 调用类型
     * @param reveiver 指定的接收者目标
     * @return
     * @throws Throwable
     */
    private static MethodHandle getPrintlnMH(Object reveiver) throws Throwable {
        ...
        MethodHandle methodHandle = lookup().findVirtual(reveiver.getClass(), "println", mt);
